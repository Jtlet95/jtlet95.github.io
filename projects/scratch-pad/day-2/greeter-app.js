...
function greeter(hour) {
    ...
    // i am going to use a conditional statment to make a greeter 
    // i need to make a var to show what time it is 
    //i have to use if statments to secure and clairfys the correct greeting based on the time 
    // having correct console.logs is how i finished 
    if(hour <= 11 && hour >= 0){
